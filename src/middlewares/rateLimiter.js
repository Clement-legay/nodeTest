...
var intervalIter = process.env.LIMITER_INTERVAL ? parseInt(process.env.LIMITER_INTERVAL) : 100;
var iterations = {
...
var limiter = new limiter_1.RateLimiter({
    tokensPerInterval: intervalIter,
    interval: "minute",
    fireImmediately: true
});
var CheckLimiter = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var method, matchingIterations, remaining, origin_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                method = req.method;
                matchingIterations = iterations[method];
                return [4 /*yield*/, limiter.removeTokens(matchingIterations)];
            case 1:
                remaining = _a.sent();
                if (remaining < 1) {
                    origin_1 = req.headers.origin;
                    res.status(429).json({ message: "Too many requests", origin: origin_1 });
                    return [2 /*return*/];
                }
                next();
                return [2 /*return*/];
